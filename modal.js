...
var modal = {
  ...
  on_submit: function (endpoint, btc_dest_address, isPP) {
    var self = this;
    var url = isPP ? endpoint + "/xmr2btc/order_create_pp/" : endpoint + "/xmr2btc/order_create/";
    var order_create_param = isPP ? {
      pp_url: btc_dest_address
    } :{
  ...
  inject_modal: function (data) {
    ...
    var is_test_net = data.is_test_net;
    ...
    var address_html =
      "<div id='xmrto-lens-modal' class='modal-container'>" +
        ...
        "</div>" +
        "<div class='xmrto-panel-body'>" +
          (is_test_net ? "<div class='stagenet-label'>stagenet</div>" : "") +
          "<div>" +
    ...
    $('body').append(isPP ? pp_html : address_html);
